...
namespace Magitek.Logic.Astrologian
{
    internal static class SingleTarget
    {
        public static async Task<bool> Malefic()
        {
            ...
            if (ActionManager.HasSpell(Spells.Malefic4.Id))
            {
                return await Spells.Malefic4.Cast(Core.Me.CurrentTarget);
            }
        ...
        private static async Task<bool> Combust()
        {
            ...
            if (ActionManager.HasSpell(Spells.Combust3.Id))
            {
                ...
                return await Spells.Combust3.CastAura(Core.Me.CurrentTarget, Auras.Combust3, true,
                    AstrologianSettings.Instance.DotRefreshSeconds * 1000);
            }
